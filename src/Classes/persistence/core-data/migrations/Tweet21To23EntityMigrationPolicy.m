...
#import "Tweet21To23EntityMigrationPolicy.h"
#import "TwitbitShared.h"

@implementation Tweet21To23EntityMigrationPolicy
                     ...
                     error:(NSError **)error
{
    ...
    if (begin)
        attributesToMigrate = [[NSMutableSet alloc] initWithObjects:
            @"identifier", @"inReplyToTwitterTweetId", @"inReplyToTweetId",
            nil];
