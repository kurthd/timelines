...
@interface FindPeopleBookmarkViewController ()
...
@implementation FindPeopleBookmarkViewController
...
- (void)displayCategory:(BookmarkCategory)category
{
    ...
    switch (category) {
        ...
        case kRecentsCategory:
            ...
            self.navigationBar.topItem.prompt =
                NSLocalizedString(@"peoplebookmarks.recents.prompt", @"");
...
- (void)configureViewForEditingSavedSearches
{
    ...
    self.navigationBar.topItem.prompt =
        NSLocalizedString(@"peoplebookmarks.savedsearches.editing.prompt", @"");
}
