...
#import "FetchRetweetsResponseProcessor.h"
#import "User.h"
...
@interface FetchRetweetsResponseProcessor ()
...
@implementation FetchRetweetsResponseProcessor
      ...
      didBuildObjects:(NSArray *)objects
{
    ...
    if (![context save:&error])
        NSLog(@"Failed to save retweets and users: '%@'", error);
